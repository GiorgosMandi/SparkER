...
object MarkovClustering extends EntityClusteringTrait {
  ...
  override def getClusters(profiles: RDD[Profile], edges: RDD[WeightedEdge], maxProfileID: Int, edgesThreshold: Double, separatorID: Long): RDD[(Long, Set[Long])] = {
  ...
  def getClusters(profiles: RDD[Profile], edges: RDD[WeightedEdge], maxProfileID: Int, edgesThreshold: Double, separatorID: Long, similarityChecksLimit: Int,
